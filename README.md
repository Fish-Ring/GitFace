...
Git 多身份与企业远程管理器 — 一键切换身份、托管提供商和 SSH 密钥，支持 TUI 和 CLI 双界面。
...
| 语言 | 入口 |
|---|---|
| 简体中文 | [安装](docs/zh-CN/install.md) · [使用](docs/zh-CN/usage.md) · [配置](docs/zh-CN/config.md) |
| 繁體中文 | [安裝](docs/zh-TW/install.md) · [使用](docs/zh-TW/usage.md) · [配置](docs/zh-TW/config.md) |
| English | [Install](docs/en/install.md) · [Usage](docs/en/usage.md) · [Config](docs/en/config.md) |
| 日本語 | [インストール](docs/ja/install.md) · [使い方](docs/ja/usage.md) · [設定](docs/ja/config.md) |
| 한국어 | [설치](docs/ko/install.md) · [사용법](docs/ko/usage.md) · [설정](docs/ko/config.md) |
